...
public class UserDialogs {
    ...
    public static String getColorLetter() {
        while (true) {
            System.out.println("Enter the first letter of the color (R-red, G-green, B-blue, Y-yellow):");
            String colorLetter = scanner.nextLine().trim().toUpperCase();
            if (colorLetter.length() == 1 && "RGBY".contains(colorLetter)) {
                return colorLetter;
            } else {
